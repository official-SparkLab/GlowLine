...
export const CustomerTable = () => {
    ...
    return (<>
            ...
            <div className="page-content">
                ...
                <div className="panel panel-white" >
                    ...
                    <div className="page-title">
                        <h3 className="breadcrumb-header">Customer List</h3>
                    </div>
                    <div id="main-wrapper">
        ...
        <Modal open={open} onClose={handleClose} component={CustomerForm} modalPurpose={modalOpenPurpose} rowDetails={row}></Modal>
