              ...
              {Array.isArray(tableData) && tableData.length > 0 &&
                tableData.map((row, index) => 
                  ...
                  <tr key={index}>
                    ...
                    <td  style={{ fontWeight: "bold",border: "0" }}>{row.rawp_id}</td>
                    <td  style={{fontWeight: "bold", border: "0" }}>{row.sup_name}</td>
                    <td  style={{ border: "0" }}>{row.invoice_no}</td>
                    <td  style={{ border: "0" }}>{row.total?parseFloat(row.total):0}</td>
                    <td  style={{ border: "0" }}>{row.sub_total?parseFloat(row.sub_total):0}</td>
                  </tr>
                  )))}
              <tr style={{height:"100%"}}>
