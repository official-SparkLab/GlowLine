...
import { EmployeeAttendeceForm } from "./EmployeeAttendenceForm"
...
export const EmployeeAttendenceTable = () => {
    ...
    useEffect(() => {
        const getEmployeeAdvPaymentDetails = async (e) => {
            const res = await axios.get(`${GlobalService.path}/fetchEmployeeAttendence`)
    ...
    const deleteItem = async (id) => {
        try {
            const response = await axios.put(`${GlobalService.path}/deleteEmployeeAttendence/${id}`);
    ...
    return (<>
            ...
            <div className="page-content">
                ...
                <div className="panel panel-white" >
                    ...
                    <div className="page-title">
                        <h3 className="breadcrumb-header">Attendance List</h3>
                    </div>
                    <div id="main-wrapper">
        ...
        <Modal open={open} onClose={handleClose} component={EmployeeAttendeceForm} modalPurpose={modalOpenPurpose} rowDetails={row}></Modal>
