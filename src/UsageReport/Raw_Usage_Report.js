...
export const Raw_Usage_List = () => {
    ...
    useEffect(() => {
        const getProductDetails = async (e) => {
            const res = await axios.get(`${GlobalService.path}/fetchRawUsage`)
            console.log(res);
                ...
                <div className="panel panel-white" >
                    ...
                    <div className="page-title row">
                        <div className="col-md-10">
                            <h3 className="breadcrumb-header">Raw Usage List</h3>
                        </div>
                                        ...
                                        (itemsToShow.map((row, index) => (
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a className="confirm-text" style={{marginLeft:"10px",cursor:"pointer"}}  onClick={() => deleteItem(row.raw_id)}>
